...
extern "C" void *sum_kernel_u32()
{
    return (void *)sumKernel<uint32_t>;
}

// A pointer to the sum kernel for felt_t.
extern "C" void *sum_kernel_felt()
{
    return (void *)sumKernel<felt_t>;
}

// A pointer to the sum kernel for ext_t.
extern "C" void *sum_kernel_ext()
{
    return (void *)sumKernel<ext_t>;
}