...
extern "C" void* prover_clean_logup_gkr_sum_as_poly_circuit_layer() {
    return (void*)sumAsPolyCircuitLayer;
}

extern "C" void* prover_clean_logup_gkr_first_sum_as_poly_circuit_layer() {
    return (void*)firstSumAsPolyCircuitLayer;
}

extern "C" void* prover_clean_logup_gkr_fix_last_variable_circuit_layer() {
    return (void*)proverCleanFixLastVariableCircuitLayer;
}

extern "C" void* prover_clean_logup_gkr_fix_last_variable_last_circuit_layer() {
    return (void*)proverCleanFixLastVariableLastCircuitLayer;
}

extern "C" void* prover_clean_logup_gkr_sum_as_poly_interactions_layer() {
    return (void*)sumAsPolyInteractionsLayer;
}

extern "C" void* prover_clean_logup_gkr_fix_last_variable_interactions_layer() {
