...
extern "C" rustCudaError_t populate_restrict_eq_host(const void* src, size_t len, cudaStream_t stream) {
    CUDA_OK(cudaMemcpyToSymbolAsync((const void*)restrictEq, src, len * sizeof(ext_t), 0, cudaMemcpyHostToDevice, stream));
    return CUDA_SUCCESS_CSL;
}

extern "C" rustCudaError_t populate_restrict_eq_device(const void* src, size_t len, cudaStream_t stream) {
    CUDA_OK(cudaMemcpyToSymbolAsync((const void*)restrictEq, src, len * sizeof(ext_t), 0, cudaMemcpyDeviceToDevice, stream));
    return CUDA_SUCCESS_CSL;
}
...
inline __constant__ felt_t evalEq<8, 4>[8][4] = {
    felt_t(0), felt_t(1), felt_t(2), felt_t(3),
    felt_t(1), felt_t(0), felt_t(3), felt_t(2),
    felt_t(2), felt_t(3), felt_t(0), felt_t(1),
    felt_t(3), felt_t(2), felt_t(1), felt_t(0),
    felt_t(4), felt_t(5), felt_t(6), felt_t(7),
    felt_t(5), felt_t(4), felt_t(7), felt_t(6),
    felt_t(6), felt_t(7), felt_t(4), felt_t(5),
    felt_t(7), felt_t(6), felt_t(5), felt_t(4),
};
...
__global__ void roundKernel(
    ...
    ext_t *q_smem = reinterpret_cast<ext_t *>(smem + warp.meta_group_size() * FIX_TILE * sizeof(ext_t));
    ext_t *result_smem = reinterpret_cast<ext_t *>(smem + warp.meta_group_size() * FIX_TILE * 2 * sizeof(ext_t));
    ...
    for (int point = 0; point < NUM_POINTS; ++point) {
        ...
        ext_t::store(result_smem, warp.meta_group_size() * point + warp.meta_group_rank(), ext_t::zero());
    }

    // Iterate over block tiles -> warp tiles 
    for (int b_idx = blockIdx.x * block_tile ; b_idx < block_height; b_idx += gridDim.x * block_tile) {
...
extern "C"  void * round_kernel_1_32_2_2_false() {
    return (void *)roundKernel<1, 32, 2, 2, false>;
}


extern "C"  void * round_kernel_2_32_2_2_true() {
    return (void *)roundKernel<2, 32, 2, 2, true>;
}

extern "C"  void * round_kernel_2_32_2_2_false() {
    return (void *)roundKernel<2, 32, 2, 2, false>;
}

extern "C"  void * round_kernel_4_32_2_2_true() {
    return (void *)roundKernel<4, 32, 2, 2, true>;
}

extern "C"  void * round_kernel_4_32_2_2_false() {
    return (void *)roundKernel<4, 32, 2, 2, false>;
}

extern "C"  void * round_kernel_8_32_2_2_true() {
    return (void *)roundKernel<8, 32, 2, 2, true>;
}

extern "C"  void * round_kernel_8_32_2_2_false() {
    return (void *)roundKernel<8, 32, 2, 2, false>;
}

// FIX_TILE=64 variants
extern "C"  void * round_kernel_1_64_2_2_false() {
    return (void *)roundKernel<1, 64, 2, 2, false>;
}

extern "C"  void * round_kernel_2_64_2_2_true() {
    return (void *)roundKernel<2, 64, 2, 2, true>;
}

extern "C"  void * round_kernel_2_64_2_2_false() {
    return (void *)roundKernel<2, 64, 2, 2, false>;
}

extern "C"  void * round_kernel_4_64_2_2_true() {
    return (void *)roundKernel<4, 64, 2, 2, true>;
}

extern "C"  void * round_kernel_4_64_2_2_false() {
    return (void *)roundKernel<4, 64, 2, 2, false>;
}

extern "C"  void * round_kernel_8_64_2_2_true() {
    return (void *)roundKernel<8, 64, 2, 2, true>;
}

extern "C"  void * round_kernel_8_64_2_2_false() {
    return (void *)roundKernel<8, 64, 2, 2, false>;
}

// NUM_POINTS=3 variants with FIX_TILE=32
extern "C"  void * round_kernel_1_32_2_3_false() {
    return (void *)roundKernel<1, 32, 2, 3, false>;
}

extern "C"  void * round_kernel_2_32_2_3_true() {
    return (void *)roundKernel<2, 32, 2, 3, true>;
}

extern "C"  void * round_kernel_2_32_2_3_false() {
    return (void *)roundKernel<2, 32, 2, 3, false>;
}

extern "C"  void * round_kernel_4_32_2_3_true() {
    return (void *)roundKernel<4, 32, 2, 3, true>;
}

extern "C"  void * round_kernel_4_32_2_3_false() {
    return (void *)roundKernel<4, 32, 2, 3, false>;
}

extern "C"  void * round_kernel_8_32_2_3_true() {
    return (void *)roundKernel<8, 32, 2, 3, true>;
}

extern "C"  void * round_kernel_8_32_2_3_false() {
    return (void *)roundKernel<8, 32, 2, 3, false>;
}

// NUM_POINTS=3 variants with FIX_TILE=64
extern "C"  void * round_kernel_1_64_2_3_false() {
    return (void *)roundKernel<1, 64, 2, 3, false>;
}

extern "C"  void * round_kernel_1_64_4_8_false() {
    return (void *)roundKernel<1, 64, 4, 8, false>;
}

extern "C"  void * round_kernel_2_64_2_3_true() {
    return (void *)roundKernel<2, 64, 2, 3, true>;
}

extern "C"  void * round_kernel_2_64_2_3_false() {
    return (void *)roundKernel<2, 64, 2, 3, false>;
}

extern "C"  void * round_kernel_4_64_2_3_true() {
    return (void *)roundKernel<4, 64, 2, 3, true>;
}

extern "C"  void * round_kernel_4_64_2_3_false() {
    return (void *)roundKernel<4, 64, 2, 3, false>;
}

extern "C"  void * round_kernel_4_64_4_8_true() {
    return (void *)roundKernel<4, 64, 4, 8, true>;
}

extern "C"  void * round_kernel_4_64_4_8_false() {
    return (void *)roundKernel<4, 64, 4, 8, false>;
}

extern "C"  void * round_kernel_8_64_2_3_true() {
    return (void *)roundKernel<8, 64, 2, 3, true>;
}

extern "C"  void * round_kernel_8_64_2_3_false() {
    return (void *)roundKernel<8, 64, 2, 3, false>;
}


extern "C"  void * round_kernel_1_128_4_8_false() {
    return (void *)roundKernel<1, 128, 4, 8, false>;
}