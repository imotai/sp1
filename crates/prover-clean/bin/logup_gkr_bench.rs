...
use csl_prover_clean::logup_gkr::bench_materialized_sumcheck;
use csl_prover_clean::logup_gkr::{random_first_layer, FirstGkrLayer, GkrCircuitLayer};
...
fn load_workloads_from_json() -> Vec<Workload> {
    let json_content = fs::read_to_string("crates/prover-clean/layer_workloads.json")
