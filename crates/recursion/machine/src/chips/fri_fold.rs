...
use sp1_recursion_executor::{
    Block, ExecutionRecord, FriFoldEvent, FriFoldInstr, Instruction, RecursionProgram,
};
...
mod tests {
    ...
    use sp1_recursion_executor::{
        instruction as instr, FriFoldBaseIo, FriFoldExtSingleIo, FriFoldExtVecIo, MemAccessKind,
    };
    ...
    #[tokio::test]
    async fn prove_babybear_circuit_fri_fold() {
        setup_logger();
