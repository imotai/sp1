...
pub(crate) unsafe fn sha256_extend(ctx: &mut JitContext, arg1: u64, arg2: u64) -> Option<u64> {
    let w_ptr = arg1;
    ...
    for i in 16..64 {
        ...
        // Read w[i-2].
        let w_i_minus_2 = memory.mr(w_ptr + (i - 2) as u64 * 8);
        ...
        // Read w[i-16].
        let w_i_minus_16 = memory.mr(w_ptr + (i - 16) as u64 * 8);

        // Read w[i-7].
        let w_i_minus_7 = memory.mr(w_ptr + (i - 7) as u64 * 8);
