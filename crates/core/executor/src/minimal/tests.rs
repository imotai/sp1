...
mod tests {
    use sp1_jit::{
        ComputeInstructions, JitContext, MemoryInstructions,
        RiscOperand, RiscRegister, SP1RiscvTranspiler, SystemInstructions, TraceCollector,
    };
    ...
    fn new_backend() -> sp1_jit::backends::x86::TranspilerBackend {
        sp1_jit::backends::x86::TranspilerBackend::new(
            0,
            1024 * 2,
            std::mem::size_of::<sp1_jit::TraceChunkRaw>() * 100,
            100,
            100,
        )
        .unwrap()
