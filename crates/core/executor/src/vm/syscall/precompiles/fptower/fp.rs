...
pub fn core_fp_op<'a, RT: SyscallRuntime<'a, true>, P: FpOpField>(
    rt: &mut RT,
    _: SyscallCode,
    _: u64,
    _: u64,
    ...
    // FP operations: same memory access pattern as FP2 but with field element size
...
pub fn tracing_fp_op<P: FpOpField>(
    rt: &mut TracingVM<'_>,
