...
impl<F, A> Clone for Machine<F, A>
where
    F: Field,
    A: MachineAir<F>,
{
    fn clone(&self) -> Self {
        Self {
            ...
            num_pv_elts: self.num_pv_elts,
            contains_global_bus: self.contains_global_bus,
        }
    }
}
    ...
    A: MachineAir<F>,
{
    ...
    pub const fn new(
        ...
        Self { chips, num_pv_elts, contains_global_bus }
    }
...
//         // TODO: Re-enable this block once we have GKR-LOGUP working.
//         unimplemented!();
...
//                             (chip_name, num_main_constraints),
//                         )
//                     })
//                     .unzip()
//             });
