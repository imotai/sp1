...
pub type BabyBearExt = BinomialExtensionField<BabyBear, 4>;

pub mod posedion2_config {
    ...
    pub type ValMmcs = FieldMerkleTreeMmcs<
        ...
        8,
    >;
    pub type ChallengeMmcs = ExtensionMmcs<BabyBear, BabyBearExt, ValMmcs>;
    pub type Challenger = DuplexChallenger<BabyBear, Perm, 16, 8>;
