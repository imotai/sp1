...
extern "C" {
    ...
    pub fn recursion_base_alu_generate_preprocessed_trace_baby_bear_kernel() -> KernelPtr;
    pub fn recursion_base_alu_generate_trace_baby_bear_kernel() -> KernelPtr;
    pub fn recursion_ext_alu_generate_preprocessed_trace_baby_bear_kernel() -> KernelPtr;
    pub fn recursion_ext_alu_generate_trace_baby_bear_kernel() -> KernelPtr;
    pub fn recursion_poseidon2_wide_generate_preprocessed_trace_baby_bear_kernel() -> KernelPtr;
    pub fn recursion_poseidon2_wide_generate_trace_baby_bear_kernel() -> KernelPtr;
